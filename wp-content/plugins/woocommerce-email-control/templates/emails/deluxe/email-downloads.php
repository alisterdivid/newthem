				...
				<?php foreach ( $columns as $column_id => $column_name ) : ?>
						...
						if ( has_action( 'woocommerce_email_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								...
								break;
								case 'download-file' : ?>
									<span style=" color: #ff0000;font-family: arial, helvetica, sans-serif;"><strong><span style="font-size: 20px"><a style="color: #ff0000;" href="<?php echo esc_url( $download['download_url'] ); ?>" class="woocommerce-MyAccount-downloads-file button alt"> Bitte bestätigen </a></span></strong></span>
								<hr width="100%" color="#190000" size="2">
								<span style="color: #ff0000;"><strong><span style="font-size: 20px;"><a style="color: #ff0000;" href="<?php echo esc_url( $download['download_url'] ); ?>" class="woocommerce-MyAccount-downloads-file button alt"> Please confirm </a></span></strong></span>
									<?php
								break;
