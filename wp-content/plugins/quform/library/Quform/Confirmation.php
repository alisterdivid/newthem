...
class Quform_Confirmation
{
    ...
    public function getMessage()
    {
        ...
        $message = apply_filters('quform_confirmation_message_' . $this->form->getId() . '_' . $this->config('id'), $message, $this, $this->form);
    ...
    public function getRedirectUrl()
    {
        ...
        $url = apply_filters('quform_confirmation_redirect_url_' . $this->form->getId() . '_' . $this->config('id'), $url, $this, $this->form);
