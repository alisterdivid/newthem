...
class Quform_Form
{
    ...
    public function renderPopup(array $options = array())
    {
        ...
        ob_start();
        ?>
        <?php echo Quform::getHtmlTag('span', $attributes, do_shortcode($options['content'])); ?>
        <div class="quform-popup">
            <?php echo $this->render($options); ?>
        </div>
        <?php
        return ob_get_clean();
    }
    ...
    protected function getEditFormLinkHtml()
    {
        ...
        if ($this->options->get('showEditLink') && $this->config('environment') != 'preview' && is_user_logged_in() && Quform::currentUserCan('quform_edit_forms')) {
    ...
    public function getSuccessMessageHtml($position = 'above')
    {
        ...
        if ($this->isSubmitted() &&
            ...
            $output = sprintf(
                '<div class="quform-success-message%s">',
    ...
    public function getPageProgressHtml()
    {
        ...
        if ($type == 'numbers' || $type == 'percentage') {
            ...
            if ($type == 'numbers') {
                 ...
                 * %1$s - the opening <span> around the current page number
                 * %2$d - the current page number
                 * %3$s - the closing </span> around the current page number
                 * %4$d - the total number of pages
                 */
                $output .= sprintf(
                    esc_html__('Page %1$s%2$d%3$s of %4$d', 'quform'),
                    '<span class="quform-page-progress-number">',
                    $currentPageIndex,
                    '</span>',
                    $this->getPageCount()
                );
                 ...
                 * %1$s - the opening <span> around the progress percentage
                 * %2$d - the page progress percentage
                 * %3$s - the closing </span> around the progress percentage
                 * %% - the percentage sign
                 */
                $output .= sprintf(
                    esc_html__('%1$s%2$d%3$s%%', 'quform'),
                    '<span class="quform-page-progress-percentage">',
                    $percent,
                    '</span>'
                );
            }
    ...
    public function getJsConfig()
    {
        $config = array(
            ...
            'errorsIcon' => $this->config('errors.icon'),
    ...
    protected function getCssSelectors()
    {
        return array(
            ...
            'submitButton' => '%s .quform-button-submit button',
            'submitButtonHover' => '%s .quform-button-submit button:hover',
            'submitButtonActive' => '%s .quform-button-submit button:active',
            'submitButtonText' => '%s .quform-button-submit button .quform-button-text',
            'submitButtonTextHover' => '%s .quform-button-submit button:hover .quform-button-text',
            'submitButtonTextActive' => '%s .quform-button-submit button:active .quform-button-text',
            'submitButtonIcon' => '%s .quform-button-submit button .quform-button-icon',
            'submitButtonIconHover' => '%s .quform-button-submit button:hover .quform-button-icon',
            'submitButtonIconActive' => '%s .quform-button-submit button:active .quform-button-icon',
            'backInner' => '%s .quform-button-back',
            'backButton' => '%s .quform-button-back button',
            'backButtonHover' => '%s .quform-button-back button:hover',
            'backButtonActive' => '%s .quform-button-back button:active',
            'backButtonText' => '%s .quform-button-back button .quform-button-text',
            'backButtonTextHover' => '%s .quform-button-back button:hover .quform-button-text',
            'backButtonTextActive' => '%s .quform-button-back button:active .quform-button-text',
            'backButtonIcon' => '%s .quform-button-back button .quform-button-icon',
            'backButtonIconHover' => '%s .quform-button-back button:hover .quform-button-icon',
            'backButtonIconActive' => '%s .quform-button-back button:active .quform-button-icon',
            'nextInner' => '%s .quform-button-next',
            'nextButton' => '%s .quform-button-next button',
            'nextButtonHover' => '%s .quform-button-next button:hover',
            'nextButtonActive' => '%s .quform-button-next button:active',
            'nextButtonText' => '%s .quform-button-next button .quform-button-text',
            'nextButtonTextHover' => '%s .quform-button-next button:hover .quform-button-text',
            'nextButtonTextActive' => '%s .quform-button-next button:active .quform-button-text',
            'nextButtonIcon' => '%s .quform-button-next button .quform-button-icon',
            'nextButtonIconHover' => '%s .quform-button-next button:hover .quform-button-icon',
            'nextButtonIconActive' => '%s .quform-button-next button:active .quform-button-icon',
            'uploadButton' => '%s .quform-upload-button',
            'uploadButtonHover' => '%s .quform-upload-button:hover',
            'uploadButtonActive' => '%s .quform-upload-button:active',
            'uploadButtonText' => '%s .quform-upload-button .quform-upload-button-text',
            'uploadButtonTextHover' => '%s .quform-upload-button:hover .quform-upload-button-text',
            'uploadButtonTextActive' => '%s .quform-upload-button:active .quform-upload-button-text',
            'uploadButtonIcon' => '%s .quform-upload-button .quform-upload-button-icon',
            'uploadButtonIconHover' => '%s .quform-upload-button:hover .quform-upload-button-icon',
            'uploadButtonIconActive' => '%s .quform-upload-button:active .quform-upload-button-icon',
        );
    }
    ...
    public static function getDefaultConfig()
    {
        return apply_filters('quform_default_config_form', array(
            ...
            'tooltipClasses' => 'qtip-plain qtip-shadow',
