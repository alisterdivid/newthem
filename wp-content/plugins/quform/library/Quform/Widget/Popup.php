...
class Quform_Widget_Popup extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        $options = array(
            'description' => __('Display one of your created forms in a popup (lightbox)', 'quform'),
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <br>
            <small><?php printf(esc_html__('JSON encoded options to pass to the popup script, %sexamples%s.', 'quform'), '<a href="http://support.themecatcher.net/?TODO" target="_blank">', '</a>'); ?></small>
        </p>
        <?php
    }
