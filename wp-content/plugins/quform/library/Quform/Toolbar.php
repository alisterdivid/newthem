...
class Quform_Toolbar
{
    ...
    public function addNodes(WP_Admin_Bar $adminBar)
    {
        ...
        if (Quform::currentUserCan('quform_edit_forms') || Quform::currentUserCan('quform_view_entries')) {
                        ...
                        foreach ($forms as $form) {
                            if ($form['id'] == $recentFormId) {
                                $adminBar->add_node(array(
                                    ...
                                    'href' => Quform::currentUserCan('quform_edit_forms') ? admin_url(sprintf('admin.php?page=quform.forms&sp=edit&id=%d', $form['id'])) : '',
        ...
        $adminBar->add_node(array(
            ...
            'href' => Quform::currentUserCan('quform_view_dashboard') ? admin_url('admin.php?page=quform.dashboard') : false,
            'parent' => false,
            'meta' => array('class' => 'quform-toolbar-menu')
        ));

        if (Quform::currentUserCan('quform_view_dashboard')) {
            $adminBar->add_node(array(
                'id' => 'quform-dashboard',
    ...
    {
        return Quform::currentUserCan(array(
