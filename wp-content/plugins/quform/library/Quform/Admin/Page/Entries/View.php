...
class Quform_Admin_Page_Entries_View extends Quform_Admin_Page_Entries
{
    ...
    {
        wp_enqueue_script('js-cookie', Quform::adminUrl('js/js.cookie.min.js'), array(), '2.1.4', true);
    ...
    public function getNavHtml(array $form = null, array $extra = array())
    {
        ...
        $extra[40] = sprintf(
            ...
            sprintf(esc_html__('Viewing entry for %s', 'quform'), $form['name'])
        );
    ...
    {
        if ( ! Quform::currentUserCan('quform_views_entries')) {
