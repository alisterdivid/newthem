...
class Quform_Admin_Page_Forms_Edit extends Quform_Admin_Page
{
    ...
    protected function enqueueStyles()
    {
        ...
        wp_enqueue_style('select2', Quform::url('css/select2.min.css'), array(), '4.0.3');
        ...
        wp_enqueue_style('kendo-common-material-core', Quform::url('css/kendo.common-material.core.min.css'), array(), '2017.1.411');
        wp_enqueue_style('kendo-material', Quform::url('css/kendo.material.min.css'), array(), '2017.1.411');
    ...
    protected function enqueueScripts()
    {
        ...
        wp_enqueue_script('select2', Quform::url('js/select2.min.js'), array('jquery'), '4.0.3', true);
        wp_enqueue_script('themecatcher-tabs', Quform::adminUrl('js/tc.tabs.min.js'), array('jquery'), '1.0.0', true);
        wp_enqueue_script('kendo-core', Quform::url('js/kendo.core.min.js'), array('jquery'), '2017.1.411', true);
        wp_enqueue_script('kendo-data', Quform::url('js/kendo.data.min.js'), array('kendo-core'), '2017.1.411', true);
        wp_enqueue_script('kendo-tabstrip', Quform::url('js/kendo.tabstrip.min.js'), array('kendo-data'), '2017.1.411', true);
        wp_enqueue_script('kendo-userevents', Quform::url('js/kendo.userevents.min.js'), array('kendo-core'), '2017.1.411', true);
        wp_enqueue_script('kendo-draganddrop', Quform::url('js/kendo.draganddrop.min.js'), array('kendo-core', 'kendo-userevents'), '2017.1.411', true);
        wp_enqueue_script('kendo-resizable', Quform::url('js/kendo.resizable.min.js'), array('kendo-core', 'kendo-draganddrop'), '2017.1.411', true);
        wp_enqueue_script('kendo-splitter', Quform::url('js/kendo.splitter.min.js'), array('kendo-resizable'), '2017.1.411', true);
    ...
    {
        ob_start();
        $shortcode = sprintf('[quform id="%d" name="%s"]', $form['id'], $form['name']);
        ?>
        <div class="qfb-nav-item">
            <a id="qfb-add-to-website" class="qfb-add-to-website-closed qfb-nav-item-link" title="<?php esc_html_e('Add to website', 'quform'); ?>"><i class="mdi mdi-add_to_queue"></i></a>
        </div>
        <div class="qfb-nav-form-info"><i class="qfb-nav-form-id"><?php echo esc_html($form['id']); ?></i><span id="qfb-nav-form-name" class="qfb-nav-form-name"><?php echo esc_html($form['name']); ?></span><input type="text" id="qfb-nav-form-shortcode" class="qfb-nav-form-shortcode" readonly value="<?php echo Quform::escape($shortcode); ?>" size="<?php echo Quform::strlen($shortcode); ?>"></div>
        <?php
