...
abstract class Quform_Element_Field extends Quform_Element
{
    ...
    {
        return Quform::escape($this->getValue());
    }
    ...
    protected function getErrorHtml()
    {
        ...
        if (Quform::isNonEmptyString($this->form->config('errors.icon'))) {
            $output .= sprintf('<span class="quform-error-icon"><i class="%s"></i></span>', Quform::escape($this->form->config('errors.icon')));
        }
