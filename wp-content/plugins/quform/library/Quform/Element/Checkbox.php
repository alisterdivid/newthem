...
class Quform_Element_Checkbox extends Quform_Element_Multi implements Quform_Element_Editable
{
    ...
    {
        return join($separator, $this->getValue());
    }
    ...
    protected function getFieldAttributes(array $option, array $context = array())
    {
        ...
        $attributes = apply_filters('quform_field_attributes', $attributes, $option, $this, $this->form, $context);
        $attributes = apply_filters('quform_field_attributes_' . $this->getIdentifier(), $attributes, $option, $this, $this->form, $context);
