...
class Quform_Container extends JuiceContainer
{
    ...
    protected function setup()
    {
        ...
        $this['adminPageFactory'] = new JuiceDefinition('Quform_Admin_Page_Factory', array('@viewFactory', '@repository', '@options', '@license', '@formFactory', '@scriptLoader', '@permissions', '@builder', '@themes', '@entryExporter', '@uploader', '@session', '@migrator'));
        ...
        $this['api'] = new JuiceDefinition('Quform_Api');
        ...
        $this['dashboardWidget'] = new JuiceDefinition('Quform_Dashboard_Widget', array('@repository', '@viewFactory'));
        ...
        $this['formImporter'] = new JuiceDefinition('Quform_Form_Importer', array('@repository'));
