    ...
    <form method="post" class="qfb-settings-form">
        ...
        <div id="qfb-settings-tabs">
            <ul class="qfb-tabs-nav qfb-cf">
                <li><a><?php esc_html_e('Global', 'quform'); ?></a></li>
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                <div class="qfb-settings-row qfb-settings-row-2">
                                    ...
                                    <div class="qfb-settings-column">
                                        <input type="text" id="qfb_default_email_name" placeholder="<?php esc_attr_e('Name (optional)', 'quform'); ?>" value="<?php echo Quform::escape($options->get('defaultName')); ?>">
                                    </div>
                                </div>
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                <div class="qfb-settings-row qfb-settings-row-2">
                                    ...
                                    <div class="qfb-settings-column">
                                        <input type="text" id="qfb_default_from_email_name" placeholder="<?php esc_attr_e('Name (optional)', 'quform'); ?>" value="<?php echo Quform::escape($options->get('defaultFromName')); ?>">
                                    </div>
                                </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php esc_html_e('Set the default locale for the Date and Time elements.', 'quform'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('Set the default formats for the Date and Time elements when displayed in the form. If empty, the Locale will determine the formats according to regional standards. To use a custom format enter the format string, see %sthis page%s for more information.', 'quform'), '<a href="http://docs.telerik.com/kendo-ui/framework/globalization/dateformatting#custom" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('Set the default formats for the Date and Time elements when displayed in notification emails and when viewing entries. If empty, the Locale will determine the formats according to regional standards. To use a custom format enter the format string, see %sthis page%s for more information.', 'quform'), '<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="qfb-setting-input">
                                <div id="qfb-custom-css-tabs">
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <p class="qfb-description"><?php esc_html_e('Enter any custom CSS to be added to the site for all devices.', 'quform'); ?></p>
                                    </div>

                                    <div class="qfb-tabs-panel">
                                        <textarea id="qfb_custom_css_tablet"><?php echo Quform::escape($options->get('customCssTablet')); ?></textarea>
                                        <p class="qfb-description"><?php esc_html_e('Enter any custom CSS to be added to the site for tablets.', 'quform'); ?></p>
                                    </div>

                                    <div class="qfb-tabs-panel">
                                        <textarea id="qfb_custom_css_phone"><?php echo Quform::escape($options->get('customCssPhone')); ?></textarea>
                                        <p class="qfb-description"><?php esc_html_e('Enter any custom CSS to be added to the site for phones.', 'quform'); ?></p>
                                    </div>
