...
/* @var $page Quform_Admin_Page_Forms_Edit */
/* @var $builder Quform_Builder */
/* @var $form array */
?><div id="qfb-top" class="qfb qfb-cf">
    ...
    ?>
    <div id="qfb-first-save-message">
        <div id="qfb-first-save-close"><i class="mdi mdi-close"></i></div>
        <div id="qfb-first-save-accordion">
            <h3 class="qfb-show-atw-content qfb-show-atw-content-closed"><i class="mdi mdi-keyboard_arrow_down"></i><?php esc_html_e('Add your form to a post or page', 'quform'); ?></h3>
            <div class="qfb-add-to-website-content-area qfb-first-save-1">
                <p><?php esc_html_e('Add or edit the page you want to show the form on. If you look above the visual editor you should see a Quform icon above it, as shown below.', 'quform'); ?></p>
                <p><img src="<?php echo esc_url(Quform::adminUrl('images/insert-screenshot.png')); ?>" alt=""></p>
                <p><?php esc_html_e('Click the Add Form button and a popup should appear, select the form from the list and click the Insert form button. The shortcode for this form should now appear inside the page editor. Alternatively, you can copy and paste one of the shortcodes below into your post or page content.', 'quform'); ?></p>
                <h4><?php esc_html_e('Standard form', 'quform'); ?></h4>
                <div id="qfb-insert-shortcode-form-code" class="qfb-insert-form-code">[quform id="<?php echo esc_html($builder->getFormConfigValue($form, 'id')); ?>" name="<?php echo esc_html($builder->getFormConfigValue($form, 'name')); ?>"]</div>
                <h4><?php esc_html_e('Popup form', 'quform'); ?></h4>
                <div id="qfb-insert-shortcode-popup-code" class="qfb-insert-form-code">[quform_popup id="<?php echo esc_html($builder->getFormConfigValue($form, 'id')); ?>" name="<?php echo esc_html($builder->getFormConfigValue($form, 'name')); ?>"]<?php esc_html_e('Change this to the text or HTML that will trigger the popup', 'quform'); ?>[/quform_popup]</div>
            </div>
            <h3 class="qfb-show-atw-content qfb-show-atw-content-closed"><i class="mdi mdi-keyboard_arrow_down"></i><?php esc_html_e('Add your form as a widget', 'quform'); ?></h3>
            <div class="qfb-add-to-website-content-area qfb-first-save-2">
                <p><?php esc_html_e('To add the form as a widget into a widget enabled area, go to the Appearance &rarr; Widgets in the WordPress navigation. Find the widget with the title "Quform" (or "Quform Popup" for a popup form) and simply drag it to your widget enabled area. Select one of the forms from the dropdown menu and click Save.', 'quform'); ?></p>
            </div>
            <h3 class="qfb-show-atw-content qfb-show-atw-content-closed"><i class="mdi mdi-keyboard_arrow_down"></i><?php esc_html_e('Add your form to a theme PHP file', 'quform'); ?></h3>
            <div class="qfb-add-to-website-content-area qfb-first-save-3">
                <p><?php esc_html_e('To add this form to one of your theme PHP files, use one of the PHP snippets below.', 'quform'); ?></p>
                <h4><?php esc_html_e('Standard form', 'quform'); ?></h4>
                <div class="qfb-insert-form-code">&lt;?php if (function_exists('quform')) echo quform('<?php echo esc_html($builder->getFormConfigValue($form, 'id')); ?>'); ?&gt;</div>
                <h4><?php esc_html_e('Popup form', 'quform'); ?></h4>
                <div class="qfb-insert-form-code">&lt;?php if (function_exists('quform_popup')) echo quform_popup('<?php echo esc_html($builder->getFormConfigValue($form, 'id')); ?>', '<?php esc_html_e('Change this to the text or HTML that will trigger the popup', 'quform'); ?>'); ?&gt;</div>
            </div>
        </div>
    </div>
                                            ...
                                            <div class="qfb-setting">
                                                ...
                                                <div class="qfb-setting-inner">
                                                    <div class="qfb-setting-input">
                                                        ...
                                                        <p class="qfb-description"><?php esc_html_e('If enabled, the submitted form data will be saved to your database and you will be able to view submitted entries within the WordPress admin.', 'quform'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="qfb-form-style-tabs">
                                            ...
                                            <div class="qfb-tabs-panel">
                                                ...
                                                <div class="qfb-settings">
                                                    ...
                                                    <div class="qfb-setting">
                                                        <div class="qfb-setting-label">
                                                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php esc_html_e('Themes define the look of your form.', 'quform'); ?></div></div>
                                                    ...
                                                    <div class="qfb-setting">
                                                        <div class="qfb-setting-label">
                                                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php esc_html_e('Choose the same background color as your site for an optimal preview.', 'quform'); ?></div></div>
                                                    ...
                                                    <div class="qfb-setting">
                                                        ...
                                                        <div class="qfb-setting-inner">
                                                            <div class="qfb-setting-input">
                                                                ...
                                                                <p class="qfb-description"><?php esc_html_e('Choose where to display the label relative to the input.', 'quform'); ?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div class="qfb-settings">
                                            ...
                                            <div class="qfb-setting">
                                                ...
                                                <div class="qfb-setting-inner">
                                                    <div class="qfb-setting-input">
                                                        <?php echo $builder->getSelectIconHtml('qfb_form_errors_icon', $builder->getFormConfigValue($form, 'errors.icon')); ?>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="qfb-setting">
                                                ...
                                                <div class="qfb-setting-inner">
                                                    <div class="qfb-setting-input">
                                                        ...
                                                        <p class="qfb-description"><?php esc_html_e('If enabled, the data will be inserted into a table you specify below, inside the WordPress database. Disable to specify your own database credentials.', 'quform'); ?></p>
                                                    </div>
                                                </div>
                                            </div>
