...
?><div id="qfb-element-settings" class="qfb-popup">
    <div id="qfb-element-settings-tabs" class="qfb-popup-content">
        <div class="qfb-settings-heading">
            <span class="qfb-element-settings-icon"><i class="mdi mdi-settings"></i></span><span id="qfb-element-settings-title"><?php esc_html_e('Element settings', 'quform'); ?></span><span id="qfb-element-settings-element-icon"></span><span id="qfb-element-settings-element-name"></span>
        </div>
        ...
        <div class="qfb-tabs-panel">
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                            ...
                            <div class="qfb-setting-input">
                                ...
                                <div class="qfb-options-inner">
                                    <div class="qfb-options-heading qfb-cf">
                                        ...
                                        <div class="qfb-options-heading-right"></div>
                                    </div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <label for="qfb_description"><?php esc_html_e('Description', 'quform'); ?></label>
                        </div>
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                            ...
                            <div class="qfb-setting-input">
                                <div id="qfb-name-tabs">
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div class="qfb-sub-setting">
                                            <div class="qfb-sub-setting-label">
                                                <label for="qfb_name_prefix_sub_label"><?php esc_html_e('Sub label', 'quform'); ?></label>
                                            </div>
                                            <div class="qfb-sub-setting-inner">
                                                <div class="qfb-sub-setting-input">
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div class="qfb-sub-setting">
                                            <div class="qfb-sub-setting-label">
                                                <label for="qfb_name_first_sub_label"><?php esc_html_e('Sub label', 'quform'); ?></label>
                                            </div>
                                            <div class="qfb-sub-setting-inner">
                                                <div class="qfb-sub-setting-input">
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div class="qfb-sub-setting">
                                            <div class="qfb-sub-setting-label">
                                                <label for="qfb_name_middle_sub_label"><?php esc_html_e('Sub label', 'quform'); ?></label>
                                            </div>
                                            <div class="qfb-sub-setting-inner">
                                                <div class="qfb-sub-setting-input">
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div class="qfb-sub-setting">
                                            <div class="qfb-sub-setting-label">
                                                <label for="qfb_name_last_sub_label"><?php esc_html_e('Sub label', 'quform'); ?></label>
                                            </div>
                                            <div class="qfb-sub-setting-inner">
                                                <div class="qfb-sub-setting-input">
                                    ...
                                    <div class="qfb-tabs-panel">
                                        ...
                                        <div class="qfb-sub-setting">
                                            <div class="qfb-sub-setting-label">
                                                <label for="qfb_name_suffix_sub_label"><?php esc_html_e('Sub label', 'quform'); ?></label>
                                            </div>
                                            <div class="qfb-sub-setting-inner">
                                                <div class="qfb-sub-setting-input">
        ...
        <div class="qfb-tabs-panel">
            ...
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                            ...
                            <div class="qfb-setting-input">
                                <select id="qfb_options_layout">
                                    ...
                                    <?php foreach (range(2, 20) as $i) : ?>
                                        <option value="<?php echo esc_attr($i); ?>"><?php echo esc_html(sprintf(_n('%d column', '%d columns', $i, 'quform'), $i)); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php esc_html_e('Enter the text that should be displayed when no options are selected.', 'quform'); ?></div></div>
                            <label for="qfb_enhanced_select_placeholder"><?php esc_html_e('Enhanced select placeholder text', 'quform'); ?></label>
                        </div>
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                <input type="text" id="qfb_enhanced_select_placeholder" placeholder="<?php esc_attr_e('Please select', 'quform'); ?>">
                                <label for="qfb_enhanced_select_placeholder"></label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php printf(esc_html__('Sets the height of the field, enter a number to that number of options at one time. Enter %sauto%s to set the height to show all options.'), '<code>', '</code>'); ?></div></div>
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php esc_html_e('Once you have added a style, enter the CSS styles.'); ?></div></div>
        ...
        <div class="qfb-tabs-panel">
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php esc_html_e('The sub label is small text shown below the field.', 'quform'); ?></div></div>
                            <label for="qfb_sub_label"><?php esc_html_e('Sub label', 'quform'); ?></label>
                        </div>
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                    ...
                    <div class="qfb-setting">
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon"><div class="qfb-tooltip-content"><?php esc_html_e('Choose where to display the label relative to the input. "Inherit" means that the label position will be inherited from the global form settings or parent group/page.', 'quform'); ?></div></div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('Enter the file extension excluding the dots and separated by commas e.g. %s.', 'quform'), '<code>jpg, jpeg, png, gif</code>'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php esc_html_e('Enter the maximum size of a file in MB.', 'quform'); ?> <a href="http://support.themecatcher.net/quform-wordpress/elements/file-upload/maximum-allowed-file-size" target="_blank"><?php esc_html_e('Important information', 'quform'); ?></a>.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="qfb-setting-label">
                            <div class="qfb-tooltip-icon">
                                <div class="qfb-tooltip-content">
                                    ...
                                    <pre><?php
                                        echo $builder->formatVariables(array(
                                            '{form_id}' => esc_html__('the form ID form', 'quform'),
                                            '{year}' => esc_html__('the current year', 'quform'),
                                            '{month}' => esc_html__('the current month', 'quform'),
                                            '{day}' => esc_html__('the current day', 'quform'),

                                        ));
                                    ?></pre>
                                    <?php esc_html_e('You can use the variables in the path.', 'quform'); ?>
                                </div>
                            </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php esc_html_e('The datepicker will be translated into the language you choose. If set to Default it will use the Locale from Edit Form &rarr; Settings &rarr; Language.', 'quform'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('The format of the date when displayed in the form. If empty, the global setting will be used or the Locale will determine the date format according to regional standards. See %sthis page%s for how to set a custom date format.', 'quform'), '<a href="http://docs.telerik.com/kendo-ui/framework/globalization/dateformatting#custom" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('The format of the date when displayed in notifications and when viewing entries. If empty, the global setting will be used or the Locale will determine the date format according to regional standards. See %sthis page%s for how to set a custom date format.', 'quform'), '<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php esc_html_e('The timepicker will be translated into the language you choose. If set to Default it will use the Locale from Edit Form &rarr; Settings &rarr; Language.', 'quform'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('The format of the time when displayed in the form. If empty, the global setting will be used or the Locale will determine the time format according to regional standards. See %sthis page%s for how to set a custom time format.', 'quform'), '<a href="http://docs.telerik.com/kendo-ui/framework/globalization/dateformatting#custom" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                ...
                                <p class="qfb-description"><?php printf(esc_html__('The format of the time when displayed in notifications and when viewing entries. If empty, the global setting will be used or the Locale will determine the time format according to regional standards. See %sthis page%s for how to set a custom time format.', 'quform'), '<a href="https://codex.wordpress.org/Formatting_Date_and_Time" target="_blank">', '</a>'); ?></p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="qfb-element-settings-inner">
                ...
                <div class="qfb-settings">
                    ...
                    <div class="qfb-setting">
                        ...
                        <div class="qfb-setting-inner">
                            <div class="qfb-setting-input">
                                <input type="text" id="qfb-element-unique-id" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php
                        ...
                        $validatorTranslations = array(
                            ...
                            'Quform_Validator_Date' => array(
                                'INVALID_DATE' => array(),
                                'TOO_EARLY' => array(
                                    '%min%' => __('the minimum date')
                                ),
                                'TOO_LATE' => array(
                                    '%max%' => __('the maximum date')
                                )
                            ),
                            'Quform_Validator_Time' => array(
                                'INVALID_TIME' => array(),
                                'TOO_EARLY' => array(
                                    '%min%' => __('the minimum time')
                                ),
                                'TOO_LATE' => array(
                                    '%max%' => __('the maximum time')
                                )
                            )
                        );
                    ?>
                                    ...
                                    <div class="qfb-setting-label">
                                        <?php if (count($variables)) : ?>
                                            <div class="qfb-tooltip-icon">
                                                <div class="qfb-tooltip-content">
                                                    <div class="qfb-tooltip-title"><?php esc_html_e('Variables', 'quform'); ?></div>
                                                    <pre><?php echo $builder->formatVariables($variables); ?></pre>
                                                    <?php esc_html_e('You can use the variables in the custom message.', 'quform'); ?>
                                                </div>
                                            </div>
                                        <?php endif; ?>
